...
Refinery::Images.configure do |config|
  ...
  config.pages_per_dialog_that_have_size_options = 24
  ...
  config.user_image_sizes = {:small=>"100x67#", :medium=>"150x85#", :large=>"1280x720#"}
  ...
  # config.datastore_root_path = "/home/ivan/work/fotoref30/public/system/refinery/images"
